...
_NON_RETRYABLE_PROCESSING_ERROR_CODES = frozenset(
    {
        ...
        "PROVIDER_CONTEXT_PROVIDER_INCOMPATIBLE",
        "PROVIDER_CAPABILITY_UNSUPPORTED",
        "ANALYSIS_PROCESSOR_SESSION_INVALID",
        ...
        "SCHEMA_MULTIPLE_OF_INVALID",
        "SCHEMA_STRING_LENGTH_INVALID",
        "SCHEMA_PATTERN_INVALID",
        "SCHEMA_ARRAY_LENGTH_INVALID",
        "SCHEMA_ARRAY_DUPLICATE_ITEM",
